...
#include "CMSRPCDPGUserCode/RPCHitAnalyzer/interface/MyRPCSimHitAnalyzer.h"
...
// member functions
//
void MyRPCSimHitAnalyzer::addHitData(int pidval,hitData &d)
{
...
void MyRPCSimHitAnalyzer::clearVec()
{
  pidvec.clear();
  regionvec.clear();
  stationvec.clear();
